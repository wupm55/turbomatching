...
compareTest[ids_List,x_,y_,OptionsPattern[]]:=Module[{results,info},
results=analizeEngineData/@getEngineData/@ids;
info=getEngineInfo/@ids;
If[OptionValue[compareTest,"showData"],
	{{plotData[results,x,y,ids],info},compareTestsData[ids,x,y,"speed"]},
	{plotData[results,x,y,ids],info}]
]
...
{
{Show[Extract[mapPlots,{1,1,1}],Extract[plotLugLines[testids],{1}],PlotRange->All],Show[Extract[mapPlots,{1,1,2}],Extract[plotLugLines[testids],{2,1}],PlotRange->All]}//Row,
 {Show[Extract[mapTPlots,{1}],Extract[plotTLugLines[testids],{1}],PlotRange->All],Show[Extract[mapTPlots,{2}],Extract[plotTLugLines[testids],{2,1}],PlotRange->All]}//Row,
 Extract[mapPlots,2]}
]
...
easyMaps:=Manipulate[plotMaps[id],{id,ListPicker[#,mapList]&}]
